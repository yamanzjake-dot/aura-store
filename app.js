...
const sitePolicies = {
    ...
    refund: { 
        ...
        content: `
        <div style="text-align: right; line-height: 1.8; font-size: 0.95rem; color: #444;">
            <p><strong>1. حق المعاينة :</strong><br>يحق للعميل فتح الطرد ومعاينة المنتج بالكامل أمام المندوب <strong>قبل الدفع</strong>. إذا لم يعجبك المنتج أو كان غير مطابق، يمكنك رفض استلامه ودفع رسوم التوصيل فقط للمندوب.</p>
            ...
            <p><strong>4. في حال وجود ممنوع المعاينة :</strong><br>يحق للعميل معاينة المنتج عند الاستلام للتأكد من مطابقة (اللون والشكل) للمواصفات المطلوبة، وذلك بحضور مندوب التوصيل. ويعد توقيع العميل بالاستلام أو مغادرة المندوب إقراراً منه بسلامة المنتج ظاهرياً ومطابقته لطلبه، وعليه يسقط حقه في أي مطالبة تتعلق بالشكل أو اللون لاحقاً..</p>
        </div>` 
    },
    contact: { 
